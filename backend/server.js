...
async function startServer() {
  ...
  app.listen(PORT, () => {
    ...
    console.log('  Public（匿名只能看到已发布内容）:');
    console.log(`    GET    ${API_PREFIX}/posts?page=1&perPage=20`);
    console.log(`    GET    ${API_PREFIX}/posts/:id`);
    console.log(`    GET    ${API_PREFIX}/pages`);
    console.log(`    GET    ${API_PREFIX}/pages/:idOrSlug`);
    console.log(`    GET    ${API_PREFIX}/categories?usedOnly=1`);
    console.log(`    GET    ${API_PREFIX}/settings`);
    console.log(`    GET    ${API_PREFIX}/posts/:id/comments`);
    console.log(`    GET    ${API_PREFIX}/comments/recent`);
